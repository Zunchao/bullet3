...
mm = p.loadURDF("/home/zheng/ws_ros/src/mp500lwa4d_description/urdf/robot.urdf")
#for i in range(100):
#    time.sleep(1./10.)
#p.disconnect()
...
while(True):
    ...
    p.setJointMotorControl2(mm, 10, controlMode=p.POSITION_CONTROL, targetPosition = targetArmPosition)
    ...
    for i in range(len(wheels)):
        p.setJointMotorControl2(mm, wheels[i], p.VELOCITY_CONTROL, targetVelocity=wheelVelocities[i], force=1000)
